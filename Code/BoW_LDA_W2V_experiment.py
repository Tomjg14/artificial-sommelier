...
w2v_labels = pickle.load(open("pickle_files/w2v_labels.p","rb"))
...
train_combined_features = sparse.hstack((train_bow_features,train_lda_features_csr,train_w2v_features_csr))

test_combined_features = sparse.hstack((test_bow_features,test_lda_features_csr,test_w2v_features_csr))
...
with open("output/bow_lda_w2v_experiment.txt","w") as outfile:
